export const alertes = [
  { id: 1, severity: 'red' as const, level: 'CRITIQUE', title: 'BTS ACSE : passage sous seuil de viabilité en 2028', etablissement: 'Établières', categorie: 'Formation', date: '15/01/2025', description: "L'effectif projeté passe de 28 à 17 élèves (-39%). Le seuil minimum est de 15. Sans action, fermeture en 2029.", recommandation: "Rapprochement avec Évron ou mutualisation des moyens." },
  { id: 2, severity: 'red' as const, level: 'CRITIQUE', title: 'CAPA Jardinier Paysagiste : non viable à horizon 2029', etablissement: 'Évron', categorie: 'Formation', date: '15/01/2025', description: "Effectif projeté : 10 élèves (seuil : 12). Baisse continue depuis 2021.", recommandation: "Transformation en Bac Pro Aménagements Paysagers." },
  ...
  { id: 7, severity: 'orange' as const, level: 'IMPORTANT', title: 'CGEA Bac Pro sous seuil en 2029', etablissement: 'Évron', categorie: 'Formation', date: '03/01/2025', description: "Effectif projeté à 24 élèves en 2029, se rapprochant du seuil de 25.", recommandation: "Renforcer la communication et étudier la mutualisation." },
  ...
  { id: 9, severity: 'yellow' as const, level: 'MODÉRÉ', title: "Attractivité en recul — Château-Gontier", etablissement: 'Évron', categorie: 'Territoire', date: '15/12/2024', description: "Premiers vœux en baisse de 15% sur 3 ans.", recommandation: "Renforcer communication locale et journées portes ouvertes." },
...
export const filieresDetaillees = [
  ...
  { filiere: 'CGEA', niveau: 'Bac Pro', effectif2025: 38, proj2028: 32, proj2030: 27, delta: -29, seuilMin: 25, etablissement: 'Évron' },
  { filiere: 'ACSE', niveau: 'BTS', effectif2025: 24, proj2028: 19, proj2030: 15, delta: -37, seuilMin: 15, etablissement: 'Évron' },
  { filiere: 'Agroéquipement', niveau: 'Bac Pro', effectif2025: 30, proj2028: 28, proj2030: 26, delta: -13, seuilMin: 20, etablissement: 'Évron' },
  { filiere: 'Viticulture', niveau: 'Bac Pro', effectif2025: 45, proj2028: 40, proj2030: 36, delta: -20, seuilMin: 20, etablissement: 'Évron' },
  { filiere: 'Aménagement Paysager', niveau: 'Bac Pro', effectif2025: 28, proj2028: 25, proj2030: 22, delta: -21, seuilMin: 15, etablissement: 'Évron' },
  { filiere: 'Hippologie', niveau: 'Bac Pro', effectif2025: 32, proj2028: 28, proj2030: 24, delta: -25, seuilMin: 15, etablissement: 'Évron' },
  { filiere: 'Services aux Personnes', niveau: 'Bac Pro', effectif2025: 25, proj2028: 23, proj2030: 20, delta: -20, seuilMin: 15, etablissement: 'Évron' },
  { filiere: 'Jardinier Paysagiste', niveau: 'CAPA', effectif2025: 15, proj2028: 12, proj2030: 9, delta: -40, seuilMin: 12, etablissement: 'Évron' },
];
...
export const personnelRH = [
  ...
  { poste: 'Enseignant Agroéquip.', etablissement: 'Évron', depart: 'Sept 2029', remplacement: true, recommandation: 'Filière dynamique' },
  { poste: 'Enseignant Viticulture', etablissement: 'Évron', depart: 'Sept 2030', remplacement: true, recommandation: 'À évaluer' },
...
export const riskMatrixData = [
  ...
  { name: 'Baisse attractivité Évron', probabilite: 50, impact: 55, eleves: 379, categorie: 'Territoire' },
